...
const Page: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    const payload = {
      ...
      account_type: "registered doctor",
      name,
      gender: searchTerm,
      dob,
      password,
    ...
    try {
      ...
      if (response.ok) {
        ...
        setTimeout(() => router.push("/professional-info"), 2000)
      } else {
          ...
          <div className="w-full justify-center   ">
            ...
            <div className="mt-5 flex w-full justify-center">
              <form onSubmit={handleSubmit}>
                ...
                <div className="search-bg mb-2 h-[40px] items-center justify-between rounded-lg px-3 py-2 hover:border-[#1B5EED4D] focus:border-[#1B5EED4D] focus:bg-[#FBFAFC] max-md:w-[340px] max-sm:mb-2 xl:w-[536px]">
                  <div className="flex">
                    <input
                      type="text"
                      id="username"
                ...
                <div className="search-bg mb-2  h-[40px] items-center justify-between rounded-lg px-3 py-2 hover:border-[#1B5EED4D] focus:border-[#1B5EED4D] focus:bg-[#FBFAFC] max-sm:mb-2 xl:w-[536px]">
                  <div className="flex">
                    <input
                      type="text"
                      id="name"
                ...
                <div className="search-bg  h-[40px] items-center justify-between rounded-lg px-3 py-2 hover:border-[#1B5EED4D] focus:border-[#1B5EED4D] focus:bg-[#FBFAFC] max-sm:mb-2 xl:w-[536px]">
                  <div className="flex">
                    <input
